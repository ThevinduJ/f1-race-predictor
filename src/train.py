...
def main():
    ...
    X_test, _y_test, _qids_test, test_ref = prepare_ranking_data(test_df)
    ...
    if X_test.empty:
        logger.warning(
            "No test data for 2025 yet. Falling back to the latest 2024 race for predictions."
        )
    ...
    test_ref.sort_values(
        by=["Year", "RoundNumber", "Prediction"],
